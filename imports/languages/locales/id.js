export const id = {
  ...
  host: {
    ...
    progress: {
      ...
      hintPenalty: 'PENALTI PETUNJUK -{time}',
    ...
    summary: {
      ...
      hintPenaltyLabel: '-{time} DARI PETUNJUK',
  ...
  mobile: {
    ...
    dashboard: {
      ...
      retry: 'Coba Lagi',
      revealHint: 'Buka Petunjuk (biaya {n} mnt)',
      hintConfirm: 'Ketuk lagi — biaya {n} mnt',
      revealingHint: 'Membuka...',
