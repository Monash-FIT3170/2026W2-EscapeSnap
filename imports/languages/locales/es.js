export const es = {
  ...
  host: {
    ...
    progress: {
      ...
      hintPenalty: 'PENALIZACIÓN POR PISTA -{time}',
    ...
    summary: {
      ...
      hintPenaltyLabel: '-{time} POR PISTAS',
  ...
  mobile: {
    ...
    dashboard: {
      ...
      retry: 'Reintentar',
      revealHint: 'Revelar Pista (cuesta {n} min)',
      hintConfirm: 'Toca de nuevo — cuesta {n} min',
      revealingHint: 'Revelando...',
      skipRound: 'Omitir Ronda',
      skipConfirm: 'Toca De Nuevo Para Renunciar',
      skipping: 'Omitiendo...',
      skipFailed: 'Error de conexión - la ronda no se omitió',
      nextRoundStarting: 'SIGUIENTE RONDA INICIANDO',
      awaitingTeam: 'ESPERANDO AL EQUIPO',
      operativesReady: '{ready} / {total} LISTOS',
      waitingBody:
        'Tu ronda está cerrada. La siguiente ronda empieza cuando cada operativo haya resuelto u omitido.',
      reportToTerminal:
        'Reagrúpense en la terminal del anfitrión para el acertijo final.',
